      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 pb-12 border-b border-white/10">
          <div className="col-span-2 md:col-span-1">
            <span
              className="text-white text-2xl tracking-[0.15em] uppercase block mb-4"
          ...
          <FooterColumn
            ...
            links={[
              ...
              { label: "Supplements", href: "/products?category=supplement" },
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="text-white/70 hover:text-[#FF5C47] transition-colors text-sm flex items-center gap-2"
              >
        ...
        <div className="pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-white/40 text-xs" style={{ fontFamily: "'Satoshi', sans-serif" }}>
            © 2025 PURESKA. All rights reserved.
          </p>
          <div className="flex items-center gap-3 text-white/30">
            <span className="text-xs border border-white/20 rounded px-2 py-0.5">VISA</span>
            <span className="text-xs border border-white/20 rounded px-2 py-0.5">MC</span>
            <span className="text-xs border border-white/20 rounded px-2 py-0.5">AMEX</span>
            <span className="text-xs border border-white/20 rounded px-2 py-0.5">PayPal</span>
          </div>
        </div>
      </div>
    </footer>
...
function FooterColumn({ title, links }: { title: string; links: { label: string; href: string }[] }) {
  return (
    <div>
      <h4 className="section-label text-white/60 mb-4">{title}</h4>
